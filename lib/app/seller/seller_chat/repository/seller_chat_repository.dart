...
final sellerChatRepositoryProvider = Provider((ref) => SellerChatRepository(
    firestore: FirebaseFirestore.instance, auth: FirebaseAuth.instance));

class SellerChatRepository {
  final FirebaseFirestore firestore;
  final FirebaseAuth auth;

  SellerChatRepository({required this.firestore, required this.auth});
